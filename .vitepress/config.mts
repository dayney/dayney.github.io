 ...
 * @LastEditTime: 2026-01-12 13:38:02
...
export default defineConfig({
  ...
  head: [
    ...
    ["script", { async: "", src: "https://www.googletagmanager.com/gtag/js?id=431292320" }],
    [
      "script",
      {},
  ...
  themeConfig: {
      ...
      "/frontend/engineering/": [
        {
          ...
          items: [
            ...
            {
              text: "自动化",
              items: [{ text: "scripts中脚本的功能", link: "/frontend/engineering/guide/scripts" }],
            },
            {
      ...
      "/frontend/scene/": [
        {
          ...
          items: [
            ...
            { text: "找出重复次数", link: "/frontend/scene/find-repeat-number" },
            { text: "深度查找", link: "/frontend/scene/find-path" },
            { text: "重定向导致的问题", link: "/frontend/scene/redirct-url" },
          ],
        },
      ],
      "/efficiency/": [
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "ESLint/Prettier/Stylelint 风格指南",
                  link: "/efficiency/ai/style-guides/eslint-prettier-stylelint-style-guide",
                },
    ...
    socialLinks: [{ icon: "github", link: "https://github.com/dayney/dayney.github.io" }],
    footer: {
