          ...
          items: [
            {
              text: 'Vue2',
              items: [
                { text: '组件结构规范', link: '/frontend/index/vue2/component-structure' },
                { text: '生命周期使用规范', link: '/frontend/index/vue2/lifecycle' },
                { text: '状态管理规范', link: '/frontend/index/vue2/state-management' },
                { text: '性能优化', link: '/frontend/index/vue2/performance-optimization' },
              ]
            },
            {
              text: 'Vue3',
              items: [
                { text: '组件结构规范', link: '/frontend/index/vue3/component-structure' },
                { text: '生命周期使用规范', link: '/frontend/index/vue3/lifecycle' },
                { text: '状态管理规范', link: '/frontend/index/vue3/state-management' },
                { text: '性能优化', link: '/frontend/index/vue3/performance-optimization' },
              ]
            },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'commit配置', link: '/frontend/engineering/example/commitlint' }
              ]
            },
            {
              text: '使用小技巧',
