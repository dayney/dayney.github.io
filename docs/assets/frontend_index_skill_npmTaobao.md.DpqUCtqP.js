import{_ as a,c as s,o as n,V as e}from"./chunks/framework.CsbsVE7l.js";const u=JSON.parse('{"title":"淘宝镜像报错","description":"","frontmatter":{"outline":"deep","editLink":false},"headers":[],"relativePath":"frontend/index/skill/npmTaobao.md","filePath":"frontend/index/skill/npmTaobao.md","lastUpdated":1748791719000}'),p={name:"frontend/index/skill/npmTaobao.md"},t=e(`<h1 id="淘宝镜像报错" tabindex="-1">淘宝镜像报错 <a class="header-anchor" href="#淘宝镜像报错" aria-label="Permalink to &quot;淘宝镜像报错&quot;">​</a></h1><h2 id="_1-前言" tabindex="-1">1 前言 <a class="header-anchor" href="#_1-前言" aria-label="Permalink to &quot;1 前言&quot;">​</a></h2><p>主要是在使用 <code> npm install</code> 可能会报如下错误。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm ERR! code CERT_HAS_EXPIRED</span></span>
...
<span class="line"><span>SASS_BINARY_SITE=http://npm.taobao.org/mirrors/node-sass</span></span></code></pre></div>`,7),o=[t];function i(l,r,c,d,h,_){return n(),s("div",null,o)}const g=a(p,[["render",i]]);export{u as __pageData,g as default};
