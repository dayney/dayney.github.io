import{_ as s,c as n,o as r,V as a}from"./chunks/framework.C-fAE6Ku.js";const u=JSON.parse('{"title":"主要是设置镜像源或者私有包的地址","description":"","frontmatter":{"outline":"deep","editLink":false},"headers":[],"relativePath":"frontend/engineering/npmrc.md","filePath":"frontend/engineering/npmrc.md","lastUpdated":1709029448000}'),p={name:"frontend/engineering/npmrc.md"},e=a(`<h1 id="主要是设置镜像源或者私有包的地址" tabindex="-1">主要是设置镜像源或者私有包的地址 <a class="header-anchor" href="#主要是设置镜像源或者私有包的地址" aria-label="Permalink to &quot;主要是设置镜像源或者私有包的地址&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>#.npmrc</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span># 老的淘宝镜像源</span></span>
<span class="line"><span>registry=https://registry.npm.taobao.org</span></span>
<span class="line"><span># 新的淘宝镜像源</span></span>
...
<span class="line"><span>sqlite3_binary_site=https://npmmirror.com/mirrors/sqlite3/</span></span></code></pre></div>`,2),i=[e];function t(o,l,c,m,_,d){return r(),n("div",null,i)}const g=s(p,[["render",t]]);export{u as __pageData,g as default};
