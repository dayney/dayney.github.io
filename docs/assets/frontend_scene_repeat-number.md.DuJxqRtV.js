import{_ as s,c as n,o as a,V as t}from"./chunks/framework.CsbsVE7l.js";const _=JSON.parse('{"title":"apply与function一起使用，返回高阶函数","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/scene/repeat-number.md","filePath":"frontend/scene/repeat-number.md","lastUpdated":1757990927000}'),e={name:"frontend/scene/repeat-number.md"},p=t(`<h1 id="apply与function一起使用-返回高阶函数" tabindex="-1">apply与function一起使用，返回高阶函数 <a class="header-anchor" href="#apply与function一起使用-返回高阶函数" aria-label="Permalink to &quot;apply与function一起使用，返回高阶函数&quot;">​</a></h1><h2 id="实现一个countsubstring-str-substr-通用函数-统计substr在str中出现的次数-不允许重复匹配" tabindex="-1">实现一个countSubstring(str, subStr)通用函数，统计subStr在str中出现的次数，不允许重复匹配 <a class="header-anchor" href="#实现一个countsubstring-str-substr-通用函数-统计substr在str中出现的次数-不允许重复匹配" aria-label="Permalink to &quot;实现一个countSubstring(str, subStr)通用函数，统计subStr在str中出现的次数，不允许重复匹配&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>function countSubstring(str, subStr) {</span></span>
...
<span class="line"><span>// 期望输出：3</span></span></code></pre></div>`,3),r=[p];function l(c,i,o,u,d,b){return a(),n("div",null,r)}const g=s(e,[["render",l]]);export{_ as __pageData,g as default};
