...
<span class="line"><span>  &lt;/script&gt;</span></span>
<span class="line"><span>&lt;/body&gt;</span></span>
<span class="line"><span>&lt;/html&gt;</span></span></code></pre></div><h3 id="参考文档" tabindex="-1">参考文档 <a class="header-anchor" href="#参考文档" aria-label="Permalink to &quot;参考文档&quot;">​</a></h3><p><a href="https://cloud.tencent.com/developer/article/1405442" target="_blank" rel="noreferrer">vue 的上拉加载，下拉刷新（基于better-scrol）</a></p>`,14),e=[t];function i(c,o,r,d,g,u){return a(),n("div",null,e)}const m=s(l,[["render",i]]);export{f as __pageData,m as default};
