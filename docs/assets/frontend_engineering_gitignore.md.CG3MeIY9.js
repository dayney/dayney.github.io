import{_ as n,c as s,o as a,V as p}from"./chunks/framework.CthfA3PS.js";const b=JSON.parse('{"title":"项目中**.gitignore**的常规配置","description":"","frontmatter":{"outline":"deep","editLink":false},"headers":[],"relativePath":"frontend/engineering/gitignore.md","filePath":"frontend/engineering/gitignore.md","lastUpdated":1726155084000}'),e={name:"frontend/engineering/gitignore.md"},l=p(`<h1 id="项目中-gitignore-的常规配置" tabindex="-1">项目中**.gitignore**的常规配置 <a class="header-anchor" href="#项目中-gitignore-的常规配置" aria-label="Permalink to &quot;项目中**.gitignore**的常规配置&quot;">​</a></h1><h3 id="一、使用命令行工具生成" tabindex="-1">一、使用命令行工具生成 <a class="header-anchor" href="#一、使用命令行工具生成" aria-label="Permalink to &quot;一、使用命令行工具生成&quot;">​</a></h3><div class="language-node vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">node</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npx gitignore node</span></span></code></pre></div><h3 id="二、手动创建-gitignore-文件" tabindex="-1">二、手动创建 .gitignore 文件 <a class="header-anchor" href="#二、手动创建-gitignore-文件" aria-label="Permalink to &quot;二、手动创建 .gitignore 文件&quot;">​</a></h3><p>​ 1. 手动在项目的根目录下创建 .gitignore 文件，并且填写以下文件。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># Node.js</span></span>
