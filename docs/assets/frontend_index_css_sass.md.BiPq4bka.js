...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> */</span></span></code></pre></div><h3 id="_9-最佳实践" tabindex="-1">9. 最佳实践 <a class="header-anchor" href="#_9-最佳实践" aria-label="Permalink to &quot;9. 最佳实践&quot;">​</a></h3><ol><li>避免过深的嵌套</li><li>使用变量存储重复值</li><li>使用 Mixin 处理重复的样式</li><li>使用函数处理计算</li><li>使用占位符处理共享样式</li><li>保持代码组织清晰</li><li>使用有意义的命名</li><li>遵循 BEM 命名方法</li></ol><p><a href="https://github.com/o2team/guide" target="_blank" rel="noreferrer">o2team/guide</a></p>`,35);function y(F,C,u,b,m,B){const n=l("font");return e(),h("div",null,[r,a("h3",c,[t(n,{color:"#f00"},{default:k(()=>[s("【强调】: "),E,s("？")]),_:1}),s(),g]),o])}const v=p(d,[["render",y]]);export{x as __pageData,v as default};
