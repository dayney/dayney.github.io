import{_ as a,c as s,o as n,V as e}from"./chunks/framework.C-fAE6Ku.js";const u=JSON.parse('{"title":"淘宝镜像报错","description":"","frontmatter":{"outline":"deep","editLink":false},"headers":[],"relativePath":"efficiency/skill/npmTaobao.md","filePath":"efficiency/skill/npmTaobao.md","lastUpdated":1720610890000}'),p={name:"efficiency/skill/npmTaobao.md"},t=e(`<h1 id="淘宝镜像报错" tabindex="-1">淘宝镜像报错 <a class="header-anchor" href="#淘宝镜像报错" aria-label="Permalink to &quot;淘宝镜像报错&quot;">​</a></h1><h2 id="_1-前言" tabindex="-1">1 前言 <a class="header-anchor" href="#_1-前言" aria-label="Permalink to &quot;1 前言&quot;">​</a></h2><p>主要是在使用 <code> npm install</code> 可能会报如下错误。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm ERR! code CERT_HAS_EXPIRED</span></span>
