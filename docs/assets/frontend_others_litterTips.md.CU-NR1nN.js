import{_ as s,c as i,o as a,V as n}from"./chunks/framework.CsbsVE7l.js";const y=JSON.parse('{"title":"编程小技巧","description":"","frontmatter":{"outline":"deep","editLink":false},"headers":[],"relativePath":"frontend/others/litterTips.md","filePath":"frontend/others/litterTips.md","lastUpdated":1721102192000}'),p={name:"frontend/others/litterTips.md"},l=n(`<h1 id="编程小技巧" tabindex="-1">编程小技巧 <a class="header-anchor" href="#编程小技巧" aria-label="Permalink to &quot;编程小技巧&quot;">​</a></h1><ol><li><p>超过3个if...else if的使用技巧</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"></span>
